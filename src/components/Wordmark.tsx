...
export function Wordmark() {
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between px-4 pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] backdrop-blur-md bg-bg/80 sm:pt-5 sm:px-6">
