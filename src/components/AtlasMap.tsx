  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      map = L.map(ref.current, {
        ...
        zoomSnap: 0.5,             // snap to half-levels — decisive but not jarring
        zoomDelta: 1,
        wheelPxPerZoomLevel: 40,   // zoom faster per scroll tick
        wheelDebounceTime: 20,     // respond in 20ms instead of 40ms default
