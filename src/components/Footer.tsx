...
export function Footer() {
  return (
    // text-muted-2 (not text-muted): the small link text needs ≥4.5:1 contrast on bg
    <footer className="mt-16 flex flex-wrap items-center gap-x-6 gap-y-2 border-t border-line px-5 py-6 font-mono text-[10px] uppercase tracking-[0.16em] text-muted-2">
